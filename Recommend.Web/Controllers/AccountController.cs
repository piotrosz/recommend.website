...
namespace Recommend.UI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // TODO: Implement
        [AllowAnonymous]
        public ActionResult RecoverPassword(string resetToken)
        {
            // Create new password
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = _unitOfWork.Users.List().FirstOrDefault(u => u.UserName.ToLower() == model.UserName.ToLower());

                // Check if user already exists
                if (user == null)
                {
                    // Insert name into the profile table
                    _unitOfWork.Users.Insert(new User { UserName = model.UserName });
                    _unitOfWork.Save();
